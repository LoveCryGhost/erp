...
<div class="container-full">
        ...
        <section class="content">
            <form method="post" action="{{route('admin.role.update', ['role' => $role->id])}}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 text-right mb-5">
                        <a class="btn btn-warning" href="{{route('admin.role.index')}}" ><i class="fa fa-list"></i></a>
