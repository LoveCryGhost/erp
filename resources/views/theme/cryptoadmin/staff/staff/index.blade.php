                                ...
                                <table class="itable">
                                    ...
                                    @foreach($staffs as $staff)
                                        <tr>
                                            ...
                                            <td>{{$staff->join_at}}</td>
                                            <td>
                                                <a class="btn btn-warning" href="{{route('staff.staff.edit', ['staff'=> $staff->id])}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-danger" href="javascript:void(0);" onclick="$(this).find('form').submit();" >
                                                    <i class="fa fa-trash"></i>
                                                    <form action="{{route('staff.staff.destroy', $staff->id)}}" method="post" class="m-b-0">
                                                        @csrf
