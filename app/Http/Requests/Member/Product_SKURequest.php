...
class Product_SKURequest extends Request
{
    ...
    public function messages()
    {
        return [
            ...
            'height_pcs.numeric' =>  __('member/validations.product.sku.height_pcs.numeric'), //'售價必須為數字',
            ...
            'height_box.numeric' =>  __('member/validations.product.sku.height_box.numeric'), //'售價必須為數字',
